...
首先你需要一个域名。个人比较推荐 [万网][]，我的域名是在万网买的。【好不容易抢到 cylong.com 这个域名，之前被人注册了，不过在16年2月份的时候就过期了，哈哈哈】
...
# 感谢
> [Xuanwo's Blog - 史上最详细的 Hexo 博客搭建图文教程][1]
> [HelloDog - 使用 GitHub 和 Hexo 搭建免费静态Blog][2]
> [潇潇 - 搭建 hexo 部署到 github 图文教程][3]
...
[Node.js]: http://nodejs.cn/download/ "Node.js"
...
[1]: https://xuanwo.io/2015/03/26/hexo-intor/ "Xuanwo's Blog - 史上最详细的Hexo博客搭建图文教程"
[2]: https://wsgzao.github.io/post/hexo/ "HelloDog - 使用GitHub和Hexo搭建免费静态Blog"
...
[8]: http://wowubuntu.com/markdown/ "Markdown 语法说明(简体中文版)"
[9]: http://www.cylong.com/categories/Hexo/ "分类：Hexo | 笑话人生"
